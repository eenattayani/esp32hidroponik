...
/** variabel start*/
    $ketLantai = "LANTAI 1";
    $tbKontrolManual = "tb_manual_a";
    $tbSetTimer = "tb_settimer_a"; 
/** variabel end*/
...
/** awal pengecekan data POST  set timer**/
	if(isset($_POST["submit0"])){
        ...
        $_SESSION['kodealat1a'] = "f";    
		$_SESSION['kontrol1a'] = $intervalmenit;
