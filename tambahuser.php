<?php
    ...
    if (isset($_POST['tambah'])) {
        ...
        if ($_POST["password"] == $_POST["confirmpassword"]) {
            ...
            $result = mysqli_query($konek, "select * from $tbUser");            
            ...
            if ($validasi) {                            
                $sql = mysqli_query($konek, "insert into $tbUser (id,username,level,password) 
                values ('','$username','karyawan','$password')"); 
                            ...
                            <div class="col-md-10">
                                <form action="" method="POST">
                                    ...
                                    <div class="mb-3 text-left">
                                        ...
                                        <input id="username" type="text" class="form-control" name="username" id="username" aria-describedby="userHelp" required maxlength="24">          
                                    </div>
                                    <div class="mb-3 text-left">
                                    ...
                                    <button type="submit" name="tambah" class="btn btn btn-warning tema-warna-c btn-sm">Simpan</button>
                                </form>
                            </div>
                        </div>                        
                    </div>
